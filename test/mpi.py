...
class TestMPI(unittest.TestCase):
    ...
    def test_set_omp_threads(self):
        ...
        optionparser = MympirunOption()
        mpi_instance = getinstance(mpim.MPI, Local, optionparser)
        if hasattr(mpi_instance, 'set_omp_threads'):
            ...
            self.fail("mpi instance has no attribute set_omp_threads: %s" % dir(mpi_instance))
    ...
    def test_set_netmask(self):
        ...
        optionparser = MympirunOption()
        mpi_instance = getinstance(mpim.MPI, Local, optionparser)
        if hasattr(mpi_instance, 'set_netmask'):
            ...
            self.fail("mpi instance has no attribute set_netmask: %s" % dir(mpi_instance))
    ...
    def test_select_device(self):
        ...
        if hasattr(mpi_instance, 'select_device'):
            ...
            self.fail("mpi instance has no attribute select_devicd: %s" % dir(mpi_instance))
    ...
    def test_make_node_file(self):
        ...
        optionparser = MympirunOption()
        mpi_instance = getinstance(mpim.MPI, Local, optionparser)
        if hasattr(mpi_instance, 'make_node_file'):
            ...
            self.fail("mpi instance has no attribute make_node_file: %s" % dir(mpi_instance))
    ...
    def test_make_mympirundir(self):
        ...
        optionparser = MympirunOption()
        mpi_instance = getinstance(mpim.MPI, Local, optionparser)
        if hasattr(mpi_instance, 'make_mympirundir'):
            ...
            self.fail("mpi instance has no attribute make_mympirundir: %s" % dir(mpi_instance))
    ...
    def test_make_mpdboot(self):
        ...
        if hasattr(mpi_instance, 'make_mpdboot'):
            ...
            self.fail("mpi instance has no attribute make_mpdboot: %s" % dir(mpi_instance))
    ...
    def test_set_mpdboot_localhost_interface(self):
        ...
        if hasattr(mpi_instance, 'set_mpdboot_localhost_interface'):
            ...
            self.fail("mpi instance has no attribute set_mpdboot_localhost_interface: %s" % dir(mpi_instance))
    ...
    def test_get_localhosts(self):
        ...
        if hasattr(mpi_instance, 'get_localhosts'):
            ...
            self.fail("mpi instance has no attribute get_localhosts: %s" % dir(mpi_instance))
    ...
    def test_set_mpiexec_opts_from_env(self):
        ...
        if hasattr(mpi_instance, 'set_mpiexec_opts_from_env'):
            ...
            self.fail("mpi instance has no attribute set_mpiexec_opts_from_env: %s" % dir(mpi_instance))
